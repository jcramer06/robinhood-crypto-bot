...
def update_normalaized_state():
    state = numpy.array([sum(trading.ylist)/len(trading.ylist), scraper.sentiment(), trading.fetch_price(), (models.PolyRegression(trading.xlist, trading.ylist)[0]), trading.buying_power])
